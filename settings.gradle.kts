...
include(":ui-kit")
include(":ui-kit:imagepicker")
include(":ui-kit:imagepicker:imagepicker-ui")
include(":ui-kit:imagepicker:imagepicker-data")
include(":ui-kit:imagepicker:imagepicker-domain")
include(":ui-kit:imageviewer")
include(":ui-kit:imageviewer:imageviewer-ui")
include(":content")
